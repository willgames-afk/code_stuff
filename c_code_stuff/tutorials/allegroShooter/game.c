 ...
 *
 * gcc game.c -o game $(pkg-config allegro-5 allegro_main-5 allegro_font-5 allegro_primitives-5 allegro_audio-5 allegro_acodec-5 allegro_image-5 --libs --cflags)
 * ./game
 */


//Has been modified to not use audio
