...
;LCD SUBROUTINES
print:;Address of null-terminated string to print to LCD is at $0000 and $0001. Max string length 256; will crash if longer.
    pha
    tya
    pha
    ldy $00
