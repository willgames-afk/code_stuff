...
function initialize() {
  ...
  $node.getElementById('assembleButton').click(function () {
    assembler.assembleCode();
  });
  $node.getElementById('notesButton').click(ui.showNotes);
...
class UI {
  ...
  stop() {
    setState(this.assembled);
  }

  debugOn() {
    setState(this.debugging);
  }

  debugOff() {
    setState(this.postDebugging);
  }
